...
Gold-standard data for VK modeling emerged as a result of surveillance efforts during the SARS-CoV-2 pandemic, allowing for work which demonstrated the value of building VK models and of collecting the data necessary to fit them [CITE].
